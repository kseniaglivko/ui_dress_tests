...
class PersonalDataPageMoreLocators:
    MORE_SECTION_BUTTON = (By.XPATH, "//*[text()='Additional names']")
...
class PersonalDataPageOptionalLocators:
    OPTIONAL_SECTION_BUTTON = (By.XPATH, "//*[text()='Optional']")
...
class PersonalDataPageTagLocators:
    TAG_SECTION_BUTTON = (By.XPATH, "//*[text()='Interests']")
    TAG_INPUT = (By.CSS_SELECTOR, "input[placeholder='Enter tags...']")
