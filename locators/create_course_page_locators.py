...
class CreateCoursePageLocators:
    ...
    COURSE_FORMAT_DATA = (By.XPATH, "//a[text()='Course format']")
    APPEARANCE_DATA = (By.XPATH, "//a[text()='Appearance']")
    FILE_DATA = (By.XPATH, "//a[text()='Files and uploads']")
    ROLE_RENAME_DATA = (By.XPATH, "//a[text()='Role renaming']")
